...
import unittest
from foo import bubbleSort
import random

class testyBubbleSort(unittest.TestCase):

    def testCzyTworzyNowaTablica(self):
        tab = [4,8,6,21,5,6,7,8,2,1,0,3,9]
        self.assertNotEqual(tab, bubbleSort(tab))

    def test1(self):
        tab = [5,3,68,4,43,6,7,34,25,7,3,35,76]
        self.assertEqual(sorted(tab), bubbleSort(tab))
    ...
    def stressTest(self):
        ...
        self.assertEqual(sorted(randomTab), bubbleSort(randomTab))
