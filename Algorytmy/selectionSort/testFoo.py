...
class testyInsertionSort(unittest.TestCase):
    ...
    def testCzyTworzyNowaTablica(self):
        ...
        self.assertNotEqual(tab, selectionSort(tab))


    def test1(self):
        tab = [5,3,68,4,43,6,7,34,25,7,3,35,76]
        self.assertEqual(sorted(tab), selectionSort(tab))
    ...
    def stressTest(self):
        ...
        self.assertEqual(sorted(randomTab), selectionSort(randomTab))
